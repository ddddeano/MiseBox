...
<template>
  <div class="choice-form">
    ...
    <div v-if="choice.team === 'current'" class="chef-interaction">
      ...
      <div>
        <p v-if="chef">
          You have a chef profile. Would you like to add this kitchen to your kitchens?
        </p>
        <p v-else>
          You do not have a chef profile. Would you like to create one and add this kitchen to it?
        </p>
